...
const Arrow = props => {
    return (
		<svg version="1.1" id={`arrow-${props.up ? 'up' : 'down'}`} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			viewBox="0 0 49.656 49.656" style={{ enableBackground: 'new 0 0 49.656 49.656' }} xmlSpace="preserve">
			<g>
